  ...
  return (
    <div className="border-border-subtle bg-card max-w-[880px] overflow-hidden rounded-[18px] border-[0.5px]">
      <div className="flex flex-col items-center gap-3 px-7 pt-10 pb-9 text-center">
        <span className="bg-soleil-50 text-soleil-700 relative inline-flex h-[60px] w-[60px] items-center justify-center rounded-[18px]">
          <Icon className="h-7 w-7" />
          <span className="bg-soleil-400 text-terre-900 border-card absolute -right-1 -bottom-1 inline-flex h-[22px] w-[22px] items-center justify-center rounded-full border-2">
        ...
        <p className="text-terre-600 m-0 max-w-[440px] text-[14px] leading-[1.55]">{note}</p>
        <span className="bg-soleil-50 text-soleil-700 inline-flex items-center rounded-full px-2.5 py-0.5 text-[11px] font-medium">
          {badge}
        </span>
      </div>
      {preview && preview.length > 0 && (
        <div className="border-border-subtle bg-terre-25 border-t-[0.5px] p-5">
          <div className="text-terre-400 mb-3 text-center text-[10px] font-semibold tracking-[1px] uppercase">
            Aperçu
          </div>
          <div className="flex justify-center gap-3 opacity-50 saturate-[0.6]">
            {preview.map((c) => (
              ...
              >
                <div className="text-terre-400 mb-2 text-[10px] font-semibold tracking-[0.8px] uppercase">
                  {c.k}
                </div>
                <div className="font-display text-terre-700 text-[24px] tracking-[-0.6px]">
                  {c.v}
                </div>
              </div>
            ))}
