/**
 * <Textarea /> — shadcn/ui adapté Terre & Soleil.
 *
 * Miroir de <Input /> :
 * - radius 12px (rounded-[12px])
 * - border terre-200, bg blanc (bg-card, comme Input), texte terre-900
 * - placeholder terre-400
  ...
  ({ className, ...props }, ref) => (
    <textarea
      ...
      className={cn(
        ...
        'focus-visible:ring-soleil-400/40 focus-visible:ring-offset-background',
